...
class BlockServer{
  ...
  _initHandler(){
     const self = this
      ...
      io.on('connection', (socket) => {
        ...
        console.log('[blockserver] device connect : ' + socket.id)
  ...
  _initCommandServer(){
    ...
    app.get('/addPolicy', function(req, res){
      ...
      res.send('<h1>addPolicy</h1>')
    })

    app.get('/deletePolicy', function(req, res){
      self.deleteOuter(1)
  ...
  makeBlock(){
    ...
    //console.log('why : ' + typeof encryptTx)
